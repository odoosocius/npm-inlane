...
export class TransferApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV1OperationTransferStartPost operation.
     * @callback moduleapi/TransferApi~apiV1OperationTransferStartPostCallback
     ...
     * @param {module:model/StartTransferReqData} body Object containing the details about the sources, quantities and destination of this transfer operation
     ...
     * @param {module:api/TransferApi~apiV1OperationTransferStartPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    apiV1OperationTransferStartPost(body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling apiV1OperationTransferStartPost");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/operation/Transfer/start', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    /**
     * Callback function to receive the result of the apiV1OperationTransferStatusGet operation.
     * @callback moduleapi/TransferApi~apiV1OperationTransferStatusGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TransferOperationStatus{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TransferApi~apiV1OperationTransferStatusGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    apiV1OperationTransferStatusGet(callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TransferOperationStatus;

      return this.apiClient.callApi(
        '/api/v1/operation/Transfer/status', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
