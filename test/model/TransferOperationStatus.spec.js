...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransferOperationStatus', function() {
      beforeEach(function() {
        instance = new InLaneApi.TransferOperationStatus();
      });

      it('should create an instance of TransferOperationStatus', function() {
        // TODO: update the code to test TransferOperationStatus
        expect(instance).to.be.a(InLaneApi.TransferOperationStatus);
      });
