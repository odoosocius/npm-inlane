...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CashCount', function() {
      beforeEach(function() {
        instance = new InLaneApi.CashCount();
      });

      it('should create an instance of CashCount', function() {
        // TODO: update the code to test CashCount
        expect(instance).to.be.a(InLaneApi.CashCount);
      });
