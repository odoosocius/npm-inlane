...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BanknotesModuleInfo', function() {
      beforeEach(function() {
        instance = new InLaneApi.BanknotesModuleInfo();
      });

      it('should create an instance of BanknotesModuleInfo', function() {
        // TODO: update the code to test BanknotesModuleInfo
        expect(instance).to.be.a(InLaneApi.BanknotesModuleInfo);
      });

      it('should have the property banknoteTemplate (base name: "banknoteTemplate")', function() {
        // TODO: update the code to test the property banknoteTemplate
        expect(instance).to.have.property('banknoteTemplate');
        // expect(instance.banknoteTemplate).to.be(expectedValueLiteral);
      });
